...
using static ProductGrpcServer.Protos.ProductProtoService;
...
static async Task GetAllProducts(ProductProtoServiceClient client)
{
    //// GetAllProducts
...
static async Task AddProductAsync(ProductProtoServiceClient client)
{
    // AddProductAsync
...
static async Task UpdateProductAsync(ProductProtoServiceClient client)
{
    // UpdateProductAsync
...
static async Task DeleteProductAsync(ProductProtoServiceClient client)
{
    // DeleteProductAsync
...
static async Task InsertBulkProduct(ProductProtoServiceClient client)
{
